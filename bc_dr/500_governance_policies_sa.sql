--Create and assign object tags, masking policies and row access policy.
...
alter table global_sales.noam_online_retail.customer add row access policy common.utility.mkt_segment_rls_policy on (c_mktsegment);