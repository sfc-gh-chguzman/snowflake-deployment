--Grant object privileges to roles and grant roles to create personas.
...
grant select on future tables in schema global_sales.noam_online_retail to role sales_analyst;
...
grant select on future tables in schema global_sales.noam_online_retail to role sales_admin;
...
----------------------Create Personas------------------
use role securityadmin;
grant role product_manager to user <admin_user>;
grant role data_science to user <admin_user>;
